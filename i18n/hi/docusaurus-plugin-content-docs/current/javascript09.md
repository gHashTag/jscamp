...
फ़ंक्शन बनाने के लिए⚙️ हम विज्ञापन का उपयोग करते हैं🗣️ कार्य।⚙️
...
`Function Expression` - यह घोषणा🗣️ समारोह⚙️, जो कुछ अभिव्यक्ति का हिस्सा है (उदाहरण के लिए, एक असाइनमेंट)।
...
:::tip Запомните!
घोषणा करके🗣️ समारोह⚙️, और फिर इसे कॉल करके, किसी भी स्थिति में, हमें फ़ंक्शन के शरीर में एल्गोरिथम (पहले वर्णित क्रियाओं) के निष्पादन का परिणाम मिलता है⚙️.
:::
