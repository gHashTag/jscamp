...
А также тем, что слой компонентов изолируется от экранов и бизнес логики фреймворком [Storybook](https://storybook.js.org) - это инструмент с открытым исходным кодом для изолированного создания компонентов пользовательского интерфейса и страниц. Он упрощает разработку пользовательского интерфейса, тестирование, документирование или же есть еще один профессиональный инструмент [Amplify Studio](https://aws.amazon.com/ru/amplify/studio/), который позволяет прямо из Figma экспортировать компонеты в React приложение. 
[AWS Amplify Studio](https://aws.amazon.com/ru/amplify/studio/) - это визуальная среда разработки для создания полнофункциональных веб- и мобильных приложений. Studio опирается на существующие возможности внутреннего строительства в AWS Amplify, что также позволяет ускорить разработку пользовательского интерфейса. С помощью Studio вы можете быстро создать целое веб-приложение, бекенд, с минимальным кодированием, сохраняя при этом полный контроль над дизайном и поведением вашего приложения с помощью кода. Доставка быстрее, легко масштабируйте и радуйте каждого пользователя.
...
А еще лучше в [AWS Amplify Studio](https://aws.amazon.com/ru/amplify/studio/) - это ускоренная разработка пользовательского интерфейса и код из Figma сразу в React.

![Figma to React](https://docs.amplify.aws/images/console/ui-figmatocode.png)

Для ускорения разработки пользовательского интерфейса Amplify Studio использует библиотеку пользовательского интерфейса Amplify, чтобы предложить десятки компонентов, таких как новостные ленты, контактные формы, карточки и примитивы электронной коммерции, такие как кнопки, текстовые области и оповещения. Все компоненты пользовательского интерфейса полностью настраиваются в Figma, предоставляя дизайнерам полный контроль над визуальным стилем компонентов в инструментах, с которыми они знакомы. Все компоненты Figma импортируются в Studio как компоненты React, которые так же хороши, как и ручной код.

<!-- Пример экспортированого компонента.
