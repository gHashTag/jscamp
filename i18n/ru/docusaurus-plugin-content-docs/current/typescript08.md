...
1. Как называется способ типизации, используемый в TypeScript?
  - Явной;
  - Утиной;
  - Строгая.
...
3. С помощью какого символа объявляется необязательное свойство?
  - `!`;
  - `?`;
  - `-`.

4. Для чего используется `readonly`?
  - Только для чтения;
  - Только для записи;
  - Незнаю.

5. Позволяют ли интерфейсы описывать типы функций?
  - Да;
  - Нет;
  - Незнаю.

6. С помощью какого ключевого слова расширяются интерфейсы?
  - yield;
  - extends;
  - export;
