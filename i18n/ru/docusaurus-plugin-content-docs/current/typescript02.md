...
1. Какой самый главный тип данных в TypeScript?
  - Any;
  - Never;
  - Void;
  - Number.

2. В какой кодировке символы типа String?
  - ASCII;
  - Unicode UTF-16;
  - Windows 1251.

3. Чем является тип Number?
  - 16-битными числами;
  - 32-битными числами;
  - 48-битными числами;
  - 64-битными числами.

4. Для чего переменные могут принимать тип Never?
  - Чтобы возвращать только true;
  - Чтобы возвращать только false;
  - Чтобы никогда не возвращать true;
  - Чтобы никогда не возвращать false.

5. Какая из струткур используется для указания каждому элементу свой тип данных?
  - Array;
  - Tuple;
  - Enum.

6. С помощью чего происходит аннотация типа?
  - `#`;
  - `as`;
  - `:`.

7. C помощью чего можно объеденить типы?
  - `|`;
  - `\`;
  - `&`.

8. С помощью чего указывается пересечение типов?
  - `$`;
  - `|`;
  - `&`.
