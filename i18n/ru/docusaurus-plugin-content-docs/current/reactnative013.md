---
id: reactnative013
title: Настройка Expo. Кастомные шрифты и иконки
sidebar_label: Настройка Expo. Кастомные шрифты и иконки
---
...
>Вам не нужна macOS для создания приложения для iOS с Expo, вам нужно только устройство iOS для запуска приложения Expo Go. Для вашей машины разработки поддерживаются Windows, Linux и macOS.
...
он не запустится в будущем, нажав `shift + d` в вашем терминале, на котором запущен Expo CLI. Запустите его снова в любое время, нажав `d` в терминале, на котором запущен Expo CLI1.
