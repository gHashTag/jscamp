...
1. Для каких скриптов задумывался JavaScript?
  - Для больших и быстрых;
  - Для больших я медленных;
  - Для маленьких и быстрых;
  - Для маленьких и медленных.

2. Что добавляет TypeScript в JavaScript?
  - Объекты;
  - Функции;
  - Типы.

3. Какую типизацию добавляет TypeScript?
  - Динамическую;
  - Статическую;
  - Последовательную.

4. В каком проекте лучше использовать TypeScript?
