...
let arr = [ 'Яблоко', { name: 'Никита' }, true, function() { console.log('привет')  } ] 

// получить элемент с индексом 1 (объект) и затем показать его свойство
console.log( arr[1].name )  // имя Никита
...
`Стек` - другой вариант применения массивов как структуры данных.
