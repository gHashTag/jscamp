...
Если Вы не создаёте статьи, а желаете исправить ошибку или недочет. Вы можете отредактировать любую статью в пару нажатий, как это сделать показано [здесь](https://react-native-village.github.io/docs/blogging-00#редактирование-статьи). Но для начала нужно создать аккаунт ``GitHub`` и подключиться к проекту. Как это осуществить показано ниже, в ``Шаге 00`` и ``Шаге 01``.
...
## Проверка грамматики
Перед отправкой статьи нужно убедиться что текст не содержит грамматических ошибок. Проверить свой текст на можно на сайте [LanguageTool](https://www.languagetool.org/).
...
![LanguageTool](/img/blogging/00/lgtool01.png)
...
5. [Сайт проверики грамматики LanguageTool](https://www.languagetool.org/)
