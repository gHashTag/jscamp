...
1. Какой синтаксис используется в операторе равно?
   x == y
   x = y
   x -- y
2. В каком случае оператор не равно возвращает true?
   Если операнды не равны
   Если операнды равны
   Если оба операнда являются объектами
3. Чем оператор равно отличается от строго равно?
...
4. Какой синтаксис у оператора строго не равно?
   !=
   !==
   ==!
5. В каком случае оператор больше возвращает ложь?
...
6. Какой синтаксис у оператора больше или равно?
   > =
   > =>
   > <=
7. В каком примере оператор меньше или равно вернёт истину?
   4 <= 5
   5 <= 4
   3 <= 2
8. Что такое условие?
   ...
   Выражение
   Значение
9. Какой блок используется, чтобы проверить несколько вариантов условия?
   else if
   if
10. Какой оператор принимает 3 операнда?
    Условный (тернарный) оператор
    Больше или равно
    Меньше или равно
