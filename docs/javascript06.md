...
В данном уроке узнаем про строки
Они будут встречаться вам в вашей работе
Сначала изучим простые шаги
Вариантов создания новой строки

Одинарные или двойные кавычки
Разницы нет, делай как тебе привычно
Но в этой системе есть закон один
Какой кавычкой начал, той и завершил

Как выглядит символ перевода строки
Что такое слэш, быстрее смотри
Как найти знак объединения строк
Тебе будет полезен этот урок

Ещё один момент, касаемо JavaScript
Содержимое строки невозможно изменить
Так что будьте повнимательнее, это не ерунда
Созданная строчка такая навсегда
...
Существует два способа добраться до конкретного символа в строке. В первом способе используется метод `charAt()`. Первый символ занимает нулевую позицию:
