...
Классы создаются🏗️ для более удобной работы с объектами, но так как JavaScript библиотека React Native учит нас функцианальному⚙️ программированию и из-за использования концепции `React Hooks`, то в рамках этого курса по JavaScript мы рассмотрим классы словно мы пришли в музей истории поглядеть на мамонта, так как мы полностью отказались от использования классов в наших мобильных приложениях.
